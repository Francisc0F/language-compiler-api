    ...
    class BuildRetrievalTests {
        ...
        public void testGetBuilds() throws Exception {
            ...
            List<Build> builds = Arrays.asList(
                    new Build("build1", "Code1", BuildLang.C),
                    new Build("build2", "Code223232323", BuildLang.C)
            );
            ...
            mockMvc.perform(get("/api/v1/builds"))
                    .andExpect(status().isOk())
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[0].name").value("build1"))
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[0].code").value("Code1"))
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[0].language").value("C"))
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[1].name").value("build2"))
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[1].code").value("Code223232323"))
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[1].language").value("C"));
        }
        ...
        public void testGetBuildsWithFieldsQueryString() throws Exception {
            ...
            mockMvc.perform(get("/api/v1/builds?fields=name,code"))
                    .andExpect(status().isOk())
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[0].name").value("build1"))
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[0].code").value("Code1"))
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[0].language").doesNotExist())
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[1].name").value("build2"))
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[1].code").value("Code223232323"))
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[1].language").doesNotExist());
        }
    }
    ...
    class BuildCreation {
        ...
        public void testCreateBuild() throws Exception {
            ...
            mockMvc.perform(post("/api/v1/builds")
                    ...
                    .andExpect(MockMvcResultMatchers.jsonPath("$.name").value("newBuild"))
        ...
        public void testCreateBuildMissingLang() throws Exception {
            ...
            mockMvc.perform(post("/api/v1/builds")
                    ...
                    .andExpect(MockMvcResultMatchers.jsonPath("$.[0]").value("Lang is required for the build"));
        }
